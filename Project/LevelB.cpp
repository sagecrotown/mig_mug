...
constexpr char SPRITESHEET_FILEPATH[] = "assets/skel.png",
          ...
          FONT_FILEPATH[] = "assets/blue_font.png",
            CSV_FILEPATH[] = "assets/platformer_2.csv",
...
void LevelB::initialise(ShaderProgram *program) {
    ...
    m_game_state.collidables[2]->set_position(glm::vec3(42.0f, -8.0f, 0.0f));
    ...
    m_game_state.target->set_position(glm::vec3(24.0f, -16.0f, 0.0f));
...
void LevelB::update(float delta_time)
{
    ...
    if (m_game_state.player->level_won()) set_scene_id(3);    // switch to next level
